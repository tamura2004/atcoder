...
/* Command for C compiler:
   gcc -c  -w  -I/home/tamura/.choosenim/toolchains/nim-0.13.0/lib -o /home/tamura/project/atcoder/src/nimcache/stdlib_etcpriv.o /home/tamura/project/atcoder/src/nimcache/stdlib_etcpriv.c */
...
static N_INLINE(NIM_BOOL, ismagicidentseparatorrune_114008)(NCSTRING cs, NI i) {
	...
	LOC2 = ((NU8)(cs[(NI)(TMP293)]) == (NU8)(128));
	LA3: ;
	LOC1 = LOC2;
	if (!(LOC1)) goto LA4;
	nimln(23, "etcpriv.nim");
	TMP294 = addInt(i, ((NI) 2));
	LOC1 = ((NU8)(cs[(NI)(TMP294)]) == (NU8)(147));
	LA4: ;
	result = LOC1;
	popFrame();
	return result;
