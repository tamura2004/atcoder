...
describe ModInt do
  it "+" do
    ...
    (1.to_m + MOD + 7).should eq 8
    (Int64::MAX.to_m + Int64::MAX).should eq 582344006
  end

  it "-" do
    (14.to_m - MOD - 7).should eq 7
  ...
  it "pow" do
    2.pow(0).should eq 1
    2.pow(1000).should eq 688423210
    2.pow(1000000000).should eq 140625001
    2.pow(Int64::MAX).should eq 529367677
  end
end
