...
#         update
#       when .< key
#         @left = left.try &.insert(k, v, P::Left) || Node(K, V).new(k, v)
#         rotate_right
#       when .> key
#         @right = right.try &.insert(k, v, P::Right) || Node(K, V).new(k, v)
#         rotate_left
#       end
#     end
...
#         self
#       when .< key
#         left.try &.find(k, P::Left) && rotate_right
#       when .> key
#         right.try &.find(k, P::Right) && rotate_left
#       end
#     end
...
#   def insert(k, v, p = P::Root)
#     @root = root.try &.insert(k, v, p) || Node(K, V).new(k, v)
#   end

#   def inspect
#     root.inspect.gsub(/nil/, "")
#   end
