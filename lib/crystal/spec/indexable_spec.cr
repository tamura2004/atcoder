...
describe Indexable do
  ...
  it "ソート済の配列に対し*u*を越える要素数を返す" do
    a = [2,4]
    a.count_greater(1).should eq 2
    a.count_greater(2).should eq 1
    a.count_greater(3).should eq 1
    a.count_greater(4).should eq 0
    a.count_greater(5).should eq 0
  end

  it "ソート済の配列に対し*u*以上の要素数を返す" do
    a = [2,4]
    a.count_greater_or_equal(1).should eq 2
    a.count_greater_or_equal(2).should eq 2
    a.count_greater_or_equal(3).should eq 1
    a.count_greater_or_equal(4).should eq 1
    a.count_greater_or_equal(5).should eq 0
  end
end