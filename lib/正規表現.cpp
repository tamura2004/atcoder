...
signed main() {
  ...
  smatch m;
  bool ans = false;
  ans |= regex_match(s,m,regex("^.*keyence$"));
  ans |= regex_match(s,m,regex("^k.*eyence$"));
  ans |= regex_match(s,m,regex("^ke.*yence$"));
  ans |= regex_match(s,m,regex("^key.*ence$"));
  ans |= regex_match(s,m,regex("^keye.*nce$"));
  ans |= regex_match(s,m,regex("^keyen.*ce$"));
  ans |= regex_match(s,m,regex("^keyenc.*e$"));
  ans |= regex_match(s,m,regex("^keyence.*$"));
  YN(ans);
}